...
import { Loader2, Ticket, Calendar, CreditCard, ExternalLink } from 'lucide-react';
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 pt-28 pb-12">
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-1">Manage your tickets and explore events</p>
        </div>
        ...
        {/* Quick Links */}
        <div className="bg-gray-900/50 border border-gold/20 rounded-xl p-6">
          <h2 className="text-xl font-bold text-gold mb-4">Quick Links</h2>
