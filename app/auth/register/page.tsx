...
import { UserPlus, Mail, Lock, Phone, User, Briefcase, AlertCircle, Loader2, ArrowLeft } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-black/40 backdrop-blur-xl border border-gold/20 rounded-2xl p-8 shadow-2xl shadow-gold/5">
          ...
          >
            ...
            <p className="text-gray-400 text-sm">Join LOFTE-3 to start listing events</p>
          </motion.div>
