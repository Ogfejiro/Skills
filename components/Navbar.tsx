...
import { Sparkles, Calendar, Users, Home, Ticket, ExternalLink, ChevronDown, Loader } from "lucide-react";
...
export default function Navbar() {
  ...
  const ticketOptions = [
    ...
    },
    {
      ...
      priceUSD: 5,
      priceNGN: 5 * 1430,
      features: ["Event Access", "Shared Accommodation (1 night)", "Basic Swag", "Breakfast"],
      type: "paid" as const,
    ...
    },
    {
      ...
      priceUSD: 9,
      priceNGN: 9 * 1430,
      features: ["Event Access", "Single Budget Accommodation (1 night)", "Basic Swag", "Breakfast"],
      type: "paid" as const,
    ...
    },
    {
      ...
      priceUSD: 6,
      priceNGN: 6 * 1430,
      features: ["VIP Access", "Priority Seating", "VIP Swag Pack", "Networking Session"],
      type: "paid" as const,
    ...
    },
    {
      ...
      priceUSD: 29,
      priceNGN: 29 * 1430,
      features: ["VIP Access", "Luxury Accommodation (2 nights)", "All Meals", "Private Transport", "Premium Swag", "Backstage Access"],
      type: "paid" as const,
                  ...
                  >
                    ...
                    <div className="p-4 border-b border-gold/10 bg-gray-900/30">
                      <div className="flex justify-between items-center">
                        <div>
                          <h3 className="font-bold text-lg text-gold">LOFTE-3 Tickets</h3>
                          <p className="text-sm text-gray-400">Main Event Tickets</p>
                        </div>
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <span className="text-sm text-gray-400">1 USD = ₦1,430</span>
                        <button
                          onClick={toggleCurrency}
                          ...
                          <div className="flex justify-between items-start">
                            ...
                            <div className="ml-4 text-right">
                              <div className={`text-2xl font-bold ${
                                ticket.type === 'free' ? 'text-green-400' : 'text-gold'
                              }`}>
                                {currency === 'NGN' ? '₦' : '$'}
                                {currency === 'NGN' 
                          ...
                          <div className="mt-3">
                            ...
                            >
                              {loading === ticket.id ? (
                                ...
                                ticket.type === 'free' ? 'Get Free Ticket' : `Pay with Flutterwave`
                              )}
                            </button>
                          </div>
                        </div>
                    ...
                    <div className="p-4 bg-gray-900/30 border-t border-gold/10">
                      <div className="text-sm text-gray-400">
                        ...
                        <p>• Need help? <a href="https://t.me/Lofte3" className="text-gold hover:underline">Contact Telegram Support</a></p>
                      </div>
                    </div>
                  </motion.div>
                )}
        ...
        {showEmailModal && selectedTicket && (
          ...
          >
            <motion.div
              ...
              className="bg-black border border-gold/20 rounded-2xl max-w-md w-full p-6"
            >
              <h3 className="text-2xl font-bold text-gold mb-2">Complete Purchase</h3>
              ...
              <input
                ...
                className="w-full p-4 bg-gray-900 border border-gray-800 rounded-lg text-white placeholder-gray-500 mb-4 focus:border-gold focus:outline-none"
                required
              />
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={!userEmail || loading === selectedTicket.id}
                  className="flex-1 py-3 bg-gradient-to-r from-gold to-gold/80 text-black font-bold rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
              ...
              <p className="text-xs text-gray-500 text-center mt-4">
                You'll be redirected to Flutterwave secure checkout
              </p>
            </motion.div>
          </motion.div>
        )}
